...
setwd("~/Dropbox/Research/AbbVie/Ratio_master_protocol/code/v2/1_1_sim_1_main/")
...
print(ind)
if (ind==1){mu_t = 0; mu_add = 0; ratio_2 = 1; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}  
if (ind==2){mu_t = 0; mu_add = 0; ratio_2 = 0.5; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}  
if (ind==3){mu_t = 0; mu_add = 0.3; ratio_2 = 1; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}  
if (ind==4){mu_t = 0; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}  
if (ind==5){mu_t = 0; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 1; 
sd_t1 = sd_t2 = 4}  
if (ind==6){mu_t = 0; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 4; 
sd_t1 = sd_t2 = 1}  
if (ind==7){mu_t = 0; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = 1; sd_p2 = 2; 
sd_t1 = 2; sd_t2 = 3}  
  
if (ind==8){mu_t = 0.5; mu_add = 0; ratio_2 = 1; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2} 
if (ind==9){mu_t = 0.5; mu_add = 0; ratio_2 = 0.5; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2} 
if (ind==10){mu_t = 0.5; mu_add = 0.3; ratio_2 = 1; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}   
if (ind==11){mu_t = 0.5; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 2; 
sd_t1 = sd_t2 = 2}  
if (ind==12){mu_t = 0.6; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 1; 
sd_t1 = sd_t2 = 4}  
if (ind==13){mu_t = 0.7; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = sd_p2 = 4; 
sd_t1 = sd_t2 = 1}  
if (ind==14){mu_t = 0.5; mu_add = 0.3; ratio_2 = 0.5; sd_p1 = 1; sd_p2 = 2; 
sd_t1 = 2; sd_t2 = 3}    
...
data.out.1 = data.frame(
  "scen" = rep(c("S1", "S2", "S3", "S4", "S5", "S6", "S7"), 2), 
